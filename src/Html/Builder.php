...
class Builder extends DataTablesHtmlBuilder
{
    ...
    use \Yajra\DataTables\Html\HasEditor;
    use \Yajra\DataTables\Html\HasOptions;
    use \Yajra\DataTables\Html\HasTable;
    use Macroable;
     ...
     * @var array<string, string|null>
     */
    protected array $theadTableClass = [];
    ...
    public function theadClass (array $attributes) {
        foreach ($attributes as $attribute => $value) {
            $this->theadTableClass[$attribute] = $value;
        }
